...
/**
				// [2020.09.23 YSH] 이미지 href 추가 여기서 부터 다시 작업 
            // [2022.01.07 ruizyi] 아래 부분 삭제
                $image.css('width', Math.min(_this.$editable.width(), $image.width()));
            // [2022.01.07 ruizyi] 아래 부분 추가    
*/
               $image.attr('data-size',  $image.width()+"|"+$image.height()+"|dataSizeParams"); 
            }
            $image.show();
...
var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
		...
		var $container = true ? this.$body : this.$editor; // [2020.09.23 YSH] 무조건 editor 에 붙도록 설정 
        ...
        var body = [
            ...
            '</div>',
            '<div class="form-group note-form-group">',
            "<label class=\"note-form-label\">" + this.lang.link.url + "1111 </label>",
